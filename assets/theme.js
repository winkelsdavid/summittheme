    ...
    var opts = {
      ...
      autoplay: this.autorotate && !this.reducedMotion
        ? {
            ...
            // BEWUSST kein pauseOnMouseEnter (User-Entscheid 2026-07-14): die Maus
            // soll die Rotation nicht anhalten. Entfernt damit auch Swipers
            // mouseleave-Handler, der run() ohne Zustands-Check aufrief und
            // Fokus-Pause (WCAG) sowie Editor-Stop wieder aushebelte.
          }
        : false,
